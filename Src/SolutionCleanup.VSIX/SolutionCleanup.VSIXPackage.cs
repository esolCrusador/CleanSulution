...
namespace GloryS.SolutionCleanup_VSIX
{
    ...
    [Guid(GuidList.guidSolutionCleanup_VSIXPkgString)]
    public sealed class SolutionCleanup_VSIXPackage : Package
    {
        /// <summary>
        ...
        /// </summary>
        public SolutionCleanup_VSIXPackage()
        {
        ...
        protected override void Initialize()
        {
            ...
            if ( null != mcs )
            {
                ...
                CommandID menuCommandID = new CommandID(GuidList.guidSolutionCleanup_VSIXCmdSet, (int)PkgCmdIDList.CleanupSolution);
                MenuCommand menuItem = new MenuCommand(MenuItemCallback, menuCommandID );
                mcs.AddCommand( menuItem );
                // Create the command for the tool window
                CommandID toolwndCommandID = new CommandID(GuidList.guidSolutionCleanup_VSIXCmdSet, (int)PkgCmdIDList.cmdidMyTool);
